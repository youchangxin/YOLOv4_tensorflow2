...
TXT_DIR = './dataset/voc2012.txt'
PASCAL_VOC_CLASSES = cfg.YOLO.CLASSES


class ParsePascalVOC(object):
    def __init__(self):
        super(ParsePascalVOC, self).__init__()
        self.all_xml_dir = './dataset/VOCdevkit/VOC2012/Annotations'
        self.all_image_dir = './dataset/VOCdevkit/VOC2012/JPEGImages'
    ...
    def __combine_info(self, image_name, box_list):
        line_str = './data/dataset/VOCdevkit/VOC2012/JPEGImages/' + image_name
        line_str += " "
        for box in box_list:
            for item in box:
                item_str = str(item)
